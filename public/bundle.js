...
(function () {
    ...
    function create_fragment$3(ctx) {
    	...
    	return {
    		...
    		h() {
    			attr(div, "class", "link svelte-hfz0be");
    		},
    		m(target, anchor) {
    ...
    function create_fragment$4(ctx) {
    	...
    	return {
    		...
    		l(nodes) {
    			div = claim_element(nodes, "DIV", { class: true });
    			var div_nodes = children(div);
    			claim_component(navlink0.$$.fragment, div_nodes);
    			t = claim_space(div_nodes);
    			claim_component(navlink1.$$.fragment, div_nodes);
    			div_nodes.forEach(detach);
    			this.h();
    		},
    		h() {
    			attr(div, "class", "sidebar svelte-1iz2jkn");
    		},
    		m(target, anchor) {
    			insert(target, div, anchor);
    			mount_component(navlink0, div, null);
    			append(div, t);
    			mount_component(navlink1, div, null);
    			current = true;
    		},
    		p(ctx, [dirty]) {
    ...
    function create_fragment$5(ctx) {
    	...
    	return {
    		...
    		h() {
    			attr(h3, "class", "svelte-1hnkl9k");
    			attr(div, "class", "list svelte-1hnkl9k");
    		},
    		m(target, anchor) {
    			insert(target, div, anchor);
    			append(div, h3);
    ...
    class List extends SvelteComponent {
    	constructor(options) {
    		super();
    		init(this, options, instance$4, create_fragment$5, safe_not_equal, { title: 0 });
    	}
    }
    ...
    // (64:12) {#if post.tags.includes('lifestyle')}
    ...
    // (63:10) {#each posts as post}
    function create_each_block_2(ctx) {
    	let show_if = /*post*/ ctx[1].tags.includes("lifestyle");
    	let if_block_anchor;
    	let current;
    ...
    // (62:8) <List title="Lifestyle">
    function create_default_slot_5(ctx) {
    	let each_1_anchor;
    	let current;
    	let each_value_2 = /*posts*/ ctx[0];
    	let each_blocks = [];
    ...
    // (74:12) {#if post.tags.includes('technical')}
    ...
    function create_default_slot_2(ctx) {
    	...
    	return {
    		...
    		l(nodes) {
    			div = claim_element(nodes, "DIV", { class: true });
    			var div_nodes = children(div);
    			claim_component(list0.$$.fragment, div_nodes);
    			t = claim_space(div_nodes);
    			claim_component(list1.$$.fragment, div_nodes);
    			div_nodes.forEach(detach);
    			this.h();
    		},
    		h() {
    			attr(div, "class", "posts svelte-o561e7");
    		},
    		m(target, anchor) {
    			insert(target, div, anchor);
    ...
    function create_fragment$6(ctx) {
    	...
    	return {
    		...
    		l(nodes) {
    			const head_nodes = query_selector_all("[data-svelte=\"svelte-uwxte3\"]", document.head);
    		...
    		h() {
    			...
    			attr(div, "class", "container svelte-o561e7");
    		},
    		m(target, anchor) {
    			insert(target, t, anchor);
    			insert(target, div, anchor);
    ...
    function create_fragment$7(ctx) {
    	...
    	return {
    		...
    		l(nodes) {
    			...
    			var h3_nodes = children(h3);
    			t = claim_text(h3_nodes, "Welcome home");
    			h3_nodes.forEach(detach);
    			div_nodes.forEach(detach);
    			this.h();
    		},
    		h() {
    			attr(div, "class", "home svelte-4h3dcq");
    		},
    		m(target, anchor) {
    			insert(target, div, anchor);
    			append(div, h3);
    ...
    function create_default_slot$3(ctx) {
    	...
    	return {
    		...
    		h() {
    			attr(div, "class", "page svelte-rfw4x3");
    		},
    		m(target, anchor) {
    ...
    function create_fragment$8(ctx) {
    	...
    	return {
    		...
    		h() {
    			attr(div, "class", "container svelte-rfw4x3");
    		},
    		m(target, anchor) {
    			insert(target, div, anchor);
    			mount_component(router, div, null);
